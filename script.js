...
// formatação completa de um número normal em moeda com caracteres nativo 
const Utils = {
    formatAmount(value) {
...
const App = {
    init() {
        ...
        // Depois de registrar o upDateBalance dentro do DOM,agora chamo a função upDateBalance
        DOM.upDateBalance()
